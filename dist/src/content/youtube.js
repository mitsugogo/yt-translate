...
const MEMBERS = [
  ...
  ["白上フブキ", "Shirakami Fubuki", ["フブさん", "フブキ", "フブちゃん", "フブキちゃん", "フブキ先輩"], ["Fubuki"]],
  ...
  ["戌神ころね", "Inugami Korone", ["ころさん", "ころね", "ころねちゃん", "ころね先輩"], ["Korone"]],
  ["兎田ぺこら", "Usada Pekora", ["ぺこら", "ぺこちゃん", "ぺこらちゃん", "ぺこーら", "ぺこら先輩"], ["Pekora"]],
  ...
  ["宝鐘マリン", "Houshou Marine", ["マリン", "船長", "マリン船長", "マリンちゃん", "マリン先輩"], ["Marine"]],
  ...
  ["雪花ラミィ", "Yukihana Lamy", ["ラミィ", "ラミィちゃん", "ラミたん", "ラミィ先輩"], ["Lamy"]],
  ["桃鈴ねね", "Momosuzu Nene", ["ねね", "ねねち", "ねねちゃん", "ねね先輩"], ["Nene"]],
  ["獅白ぼたん", "Shishiro Botan", ["ぼたん", "ししろん", "ぼたんちゃん", "ぼたん先輩"], ["Botan"]],
  ["魔乃アロエ", "Mano Aloe", ["アロエちゃん"], ["Aloe"]],
  ["尾丸ポルカ", "Omaru Polka", ["ポルポル", "ポルカちゃん", "ポルカ先輩"], ["Polka"]],
  ["ラプラス・ダークネス", "La+ Darknesss", ["ラプラス", "ラプちゃん", "ラプラスちゃん", "ラプラス先輩", "総帥", "山田"], ["Laplus", "La+"]],
  ["鷹嶺ルイ", "Takane Lui", ["ルイ", "ルイ姉", "ルイルイ", "ルイちゃん", "ルイ先輩"], ["Lui"]],
  ["博衣こより", "Hakui Koyori", ["こより", "こよちゃん", "こよりちゃん", "こより先輩", "こんこよ"], ["Koyori"]],
  ...
  ["カエラ・コヴァルスキア", "Kaela Kovalskia", ["カエラ", "カエラ神", "カエラちゃん"], ["Kaela"]],
