...
- ホロライブ配信では公式メンバー名と固有語を音声認識の文脈ヒントに追加
...
ホロライブの配信と判定できた場合は、公式メンバー名、ユニット名、「あえんびえん」などの固有語を音声認識へ文脈ヒントとして渡します。Chromeが文脈ヒントに対応していない場合は、ヒントなしの従来動作へ自動的に戻ります。短い発話が登録語と完全一致した場合は、固有名の公式表記や語録の意味を優先して翻訳します。
